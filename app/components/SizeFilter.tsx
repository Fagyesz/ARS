...
/**
 * The catalogue's size row: one chip per size something is in stock in
 * (see app/lib/sizes.ts). The active chip links back to the unfiltered URL,
 * so it works as a toggle. `hrefFor('')` must give the URL without a size.
 */
export function SizeFilter({
  ...
  return (
    <div className="catalog-size-row container" role="group" aria-label="Méret">
