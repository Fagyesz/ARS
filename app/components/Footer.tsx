              ...
              <div className="footer-grid">
                ...
                <div className="footer-brand">
                  ...
                  <div className="footer-social">
                    <a
                      href="https://www.instagram.com/ars.mosoris/"
                      target="_blank"
                    ...
                    <a
                      href="https://www.facebook.com/arsmosoris"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="Facebook"
                    >
                    ...
                    <a
                      href="https://www.tiktok.com/@ars.mosoris"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="TikTok"
                    >
                    ...
                    <a
                      href="https://www.youtube.com/@arsmosoris"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="YouTube"
                    >
                ...
                <div>
                  ...
                  <nav className="footer-links">
                    ...
                    <NavLink to="/collections/polo">Pólók</NavLink>
                    <NavLink to="/collections/taska">Táskák</NavLink>
                  </nav>
                </div>
                ...
                <div>
                  ...
                  <nav className="footer-links">
                    ...
                    <NavLink to="/blogs/events">Események</NavLink>
                    <NavLink to="/pages/about">Rólunk</NavLink>
                  </nav>
                </div>
