...
const SETTINGS = {
  ...
  shipping_carrier: 'FoxPost',
  parcel_point_price: '1300',
  home_delivery_price: '0', // 0 = not offered (mirrors the checkout's delivery options)
  free_shipping_threshold: '0', // 0 = no free-shipping threshold
...
const DEFINITIONS = [
  {type: 'shop_settings', name: 'Webshop beállítások', displayNameField: 'shipping_carrier', fieldDefinitions: [
    ...
    T('home_delivery_price', 'Házhoz szállítás ára (Ft, 0 = nincs)', 'number_integer'),
    T('free_shipping_threshold', 'Ingyenes szállítás ettől (Ft, 0 = nincs)', 'number_integer'),
